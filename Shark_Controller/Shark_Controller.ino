/*
    ...
    This works with Chip Audette's variation of OpenBCI GUI
    https://github.com/OpenBCI/OpenBCI_Processing/tree/variant_sharkSwimmer
    We had 5 people on Team Alpha, Swim, Right, Left, Dive, Climb
